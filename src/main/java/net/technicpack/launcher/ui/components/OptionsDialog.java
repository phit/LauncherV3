...
public class OptionsDialog extends LauncherDialog implements IRelocalizableResource {
    ...
    private void initComponents() {
        ...
        String aboutText = "<html><head><link rel=\"stylesheet\" type=\"text/css\" href=\"http://technicpack.net/assets/css/launcher.css\" /></head><body style=\"font-family: "+resources.getFont(ResourceLoader.FONT_OPENSANS, 12).getFamily()+";color:#D0D0D0\">";
