...
public class LauncherMain {
    ...
    public static void main(String[] args) {
        ...
        Relauncher launcher = new Relauncher(new HttpUpdateStream("http://technicpack.net/api/launcher/version/"));
...
//                }
    ...
    private static void startLauncher(TechnicSettings settings, StartupParameters startupParameters, LauncherDirectories directories, ResourceLoader resources) {
        ...
        HttpPlatformApi platform = new HttpPlatformApi("http://technicpack.net/", mirrorStore);
